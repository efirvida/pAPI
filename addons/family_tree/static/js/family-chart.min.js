...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
            ? define(["d3"], e)
            : ((t = "undefined" != typeof globalThis ? globalThis : t || self).f3 =
                e(t.f3));
})(this, function (t) {
    "use strict";
    function e(t) {
    ...
    function i(t, e, n) {
        return n.find(
            (n) =>
                n.id !== e.id &&
                (n.id === t.rels.mother || n.id === t.rels.father),
        );
    }
    function a(t, e, n) {
        if (((t.exiting = n), e))
            0 !== t.depth || t.spouse
                ? t.spouse
                    ? ((t._x = t.spouse.x), (t._y = t.spouse.y))
                    : t.is_ancestry
                        ? ((t._x = t.parent.x), (t._y = t.parent.y))
                        : ((t._x = t.psx), (t._y = t.psy))
                : ((t._x = t.x), (t._y = t.y));
        else if (n) {
            const e = t.x > 0 ? 1 : -1,
                n = t.y > 0 ? 1 : -1;
    ...
    function s(t, e) {
        ...
        t.is_ancestry || t.data.main
            ...
            : (function () {
                ...
                [t, ...i].forEach((t) =>
                    e.forEach((e) => {
                        t.data[n].children.includes(e) &&
                            (t.data[r] || (t.data[r] = {}),
                                t.data[r].children || (t.data[r].children = []),
                                t.data[r].children.push(e),
                                t.data[n].children.splice(
                                    t.data[n].children.indexOf(e),
                                    1,
                                ));
                    }),
                );
    ...
    function c(t, e) {
        return o(t, e)
            ? (e.forEach((e) => {
                for (let n in e.rels)
                    e.rels.hasOwnProperty(n) &&
                        (e.rels[n] === t.id
                            ? delete e.rels[n]
                            : Array.isArray(e.rels[n]) &&
                            e.rels[n].includes(t.id) &&
                            e.rels[n].splice(
                                e.rels[n].findIndex((e) => e === t.id),
                                1,
                            ));
            }),
                e.splice(
                ...
                { success: !0 })
            : { success: !1, error: "checkIfRelativesConnectedWithoutPerson" };
    }
    function h(t) {
        let e = JSON.parse(t);
        return (
            e.forEach((t) => (t.to_add ? l(t, e) : t)),
            e.forEach((t) => delete t.main),
            e.forEach((t) => delete t.hide_rels),
            JSON.stringify(e, null, 2)
        );
    }
    function u({ datum: t, data_stash: e, rel_type: n, rel_datum: r }) {
        function i(t) {
            !(function () {
            ...
            ? (function (t) {
                t.data.other_parent &&
                    (!(function (n) {
                        ...
                        (t.rels["M" === a.data.gender ? "father" : "mother"] =
                            a.id),
                            a.rels.hasOwnProperty("children") ||
                            (a.rels.children = []);
                        function s() {
                            const t = _({ rel_type: "spouse", rel_datum: r });
                            return i(t), m({ data_stash: e, datum: t }), t;
                        }
                        a.rels.children.push(t.id);
                    })(t.data.other_parent),
                        delete t.data.other_parent);
                (t.rels["M" === r.data.gender ? "father" : "mother"] = r.id),
                    r.rels.children || (r.rels.children = []);
                    ...
                    (r.rels[n ? "father" : "mother"] = t.id),
                        (function () {
                            ...
                            (t.rels.spouses = [i]),
                                ...
                                a.rels.spouses.push(t.id);
                        })(),
                        (t.rels.children = [r.id]);
                })(t)
                : "spouse" === n && i(t);
    }
    function p({ datum: t, new_rel_datum: e, data_stash: n }) {
        const r = e._new_rel_data.rel_type;
        if (
            (delete e._new_rel_data,
            ...
            (e.rels = {}),
                r &&
                (r.rels.children || (r.rels.children = []),
                    r.rels.children.push(e.id),
                    (e.rels.father = r.id)),
                t &&
                (t.rels.children || (t.rels.children = []),
                    t.rels.children.push(e.id),
                    (e.rels.mother = t.id));
        } else if ("spouse" === r)
            t.rels.spouses || (t.rels.spouses = []),
                t.rels.spouses.includes(e.id) || t.rels.spouses.push(e.id),
                (e.rels.children = e.rels.children.filter((r) => {
                    const i = n.find((t) => t.id === r);
                    return (
                        !!i &&
                        (i.rels.mother !== t.id &&
                            (n.find((t) => t.id === i.rels.mother) &&
                                n.splice(
                                    n.findIndex((t) => t.id === i.rels.mother),
                                    1,
                                ),
                                (i.rels.mother = e.id)),
                            i.rels.father !== t.id &&
                            (n.find((t) => t.id === i.rels.father) &&
                                n.splice(
                                    n.findIndex((t) => t.id === i.rels.father),
                                    1,
                                ),
                                (i.rels.father = e.id)),
                            !0)
                ...
                (e.rels = { spouses: [t.id], children: e.rels.children });
        else if ("father" === r) {
            if (
                ((t.rels.father = e.id),
                    (e.rels = { children: [t.id] }),
                    t.rels.mother)
            ) {
                e.rels.spouses = [t.rels.mother];
                const r = n.find((e) => e.id === t.rels.mother);
                r.rels.spouses || (r.rels.spouses = []),
                    r.rels.spouses.push(e.id);
            }
        } else if (
            "mother" === r &&
            ((t.rels.mother = e.id),
    ...
    function _({ data: t, rel_type: e, rel_datum: n }) {
        const r = (function (t, e) {
            return ["daughter", "mother"].includes(e) ||
                ("spouse" === e && "M" === t.data.gender)
                ? "F"
                : "M";
        })(n, e);
        return f({ data: (t = Object.assign(t || {}, { gender: r })) });
    }
    function m({ data_stash: t, datum: e }) {
        t.push(e);
    }
    function y({ data: t, version: e }) {
        return { data: [f({ data: t })], version: e };
    }
    function g(t, e) {
        const n = t.data.rels;
        return [n.father, n.mother, ...(n.spouses || []), ...(n.children || [])]
            .filter((t) => t)
            .every((t) => e.some((e) => e.data.id === t));
    }
    function v({
        data: t,
        main_id: e = null,
        ...
        const d = s
            ? (function (t) {
                ...
                for (let e = 0; e < t.length; e++) {
                    ...
                    if (r.rels.children && r.rels.children.length > 0) {
                        ...
                        r.rels.children.forEach((a) => {
                            ...
                            s.rels[e ? "father" : "mother"] === r.id &&
                                (s.rels[e ? "mother" : "father"] ||
                                    (i ||
                                        ((i = n(r)),
                                            r.rels.spouses.push(i.id)),
                                        i.rels.children.push(s.id),
                                        (s.rels[e ? "mother" : "father"] =
                                            i.id)));
                        });
                    }
                ...
                function n(t) {
                    const n = f({
                        data: { gender: "M" === t.data.gender ? "F" : "M" },
                        rels: { spouses: [t.id], children: [] },
                    });
        ...
        const u =
            ((_ = c),
                ...
                p.forEach((t) => (1 === t.depth ? (t.parent = _[0]) : null)),
                [..._, ...p.slice(1)]);
        var p, _;
        !(function ({ tree: t }) {
            t.forEach((e) => {
            ...
            (function ({ tree: t, node_separation: e }) {
                for (let n = t.length; n--;) {
                    const r = t[n];
                    if (
                        !r.is_ancestry &&
                        r.data.rels.spouses &&
                        r.data.rels.spouses.length > 0
                    ) {
                        const n = "M" === r.data.data.gender ? -1 : 1;
                        (r.x += (r.data.rels.spouses.length / 2) * e * n),
                            r.data.rels.spouses.forEach((i, a) => {
                                const s = {
                                ...
                                (s.x = r.x - e * (a + 1) * n),
                                    (s.y = r.y),
                                    (s.sx = a > 0 ? s.x : s.x + (e / 2) * n),
                                    (s.sy = a > 0 ? s.y : s.y + (e / 2) * n),
                                    (s.depth = r.depth),
                                    (s.spouse = r),
                                    r.spouses || (r.spouses = []),
                                    r.spouses.push(s),
            ...
            (function ({ tree: t }) {
                ...
                t.forEach((t) => {
                    ...
                    if (n && r) {
                        n.added ||
                            r.added ||
                            console.error("no added spouse", n, r);
                        i(t, n.added ? n : r);
                    } else if (n || r) {
                        const e = n || r;
        ...
        function y(t, e, i) {
            const s =
                "children" === e
                    ? function (t) {
                        return [...(t.rels.children || [])].map((t) =>
                            d.find((e) => e.id === t),
                        );
                    }
                    : function (t) {
                        return [t.rels.father, t.rels.mother]
                            .filter((t) => t)
                            .map((t) => d.find((e) => e.id === t));
                    },
                o = r
                    .tree()
                    .nodeSize([n, a])
                        ...
                        i ||
                            (c(t, e) || (n += 0.25),
                                ...
                                (n += (function (t, e) {
                                    return (
                                        0.5 *
                                        ((t.data.rels.spouses || []).length +
                                            (e.data.rels.spouses || []).length)
                                    );
                                })(t, e)),
                                c(t, e) &&
                                !(function (t, e) {
    ...
    function x({ t: t, svg: e, transition_time: n = 2e3 }) {
        ...
        r.select(i)
            ...
            .duration(n || 0)
            .delay(n ? 100 : 0)
            .call(a.transform, r.zoomIdentity.scale(t.k).translate(t.x, t.y));
    }
    function b({
        svg: t,
        svg_dim: e,
        ...
        x({ t: C(e, n), svg: t, with_transition: r, transition_time: i });
    }
    function C(t, e) {
    ...
    function w({ datum: t, svg: e, svg_dim: n, scale: r, transition_time: i }) {
        const a = r || 1;
        x({
            t: {
                k: a,
    ...
    function $({ d: t, tree: e, is_horizontal: n = !1 }) {
        const r = [];
        return (
            t.data.rels.spouses &&
            t.data.rels.spouses.length > 0 &&
            (function ({ d: t }) {
            ...
            (function ({ d: t }) {
                ...
                const e = t.parents[0],
                    n = t.parents[1] || e,
                    a = { x: i(e, n, "x"), y: i(e, n, "y") };
                r.push({
                    d: s(t, a),
                    _d: () => s({ x: t.x, y: t.y }, { x: t.x, y: t.y }),
                    curve: !0,
                    id: o(t, e, n),
                    depth: t.depth + 1,
                    is_ancestry: !0,
                    ...
                    const c =
                        (function (t, e, n) {
                            return d(
                                ...
                                (n) =>
                                    n.data.id !== e.data.id &&
                                    (n.data.id === t.data.rels.mother ||
                                        n.data.id === t.data.rels.father),
                            );
                        })(i, t, e) || t,
                        h = c.sx,
                        u = n ? { x: t.x, y: h } : { x: h, y: t.y };
                    r.push({
                        d: s(i, u),
                        _d: () => s(u, { x: a(u, "x"), y: a(u, "y") }),
                        curve: !0,
                        id: o(i, t, c),
                        depth: t.depth + 1,
                        is_ancestry: !1,
        ...
        onZoomSetup: function (t, e) {
            return function (n) {
                ...
                r
                    ...
                    .style(
                        "transform",
                        `translate(${i.x}px, ${i.y}px) scale(${i.k}) `,
                    ),
                    r
                        .select(e())
                        .style(
        ...
        setupReactiveTreeData: function (t) {
            ...
            return function (n) {
                const r = (function (t, e) {
                    return e.length > 0
                        ? e.filter(
                            (e) => !t.find((t) => t.data.id === e.data.id),
                        )
                        : [];
                })(n, e);
    ...
    function A(t, e, n) {
        ...
        return (
            (0 === e.depth && !e.spouse) ||
            e.is_ancestry ||
            ((a += i * r), e.spouse && (a += r), (a += e.depth * r)),
            a
        );
    }
    function H(t, { d: e }) {
        ...
        return (
            ...
            t.updateMainId(e.data.id),
            t.updateTree({ tree_position: t.state.tree_fit_on_change }),
            !0
        );
    }
    function D(t, { d: e, cardEditForm: n }) {
        const r = e.data;
        n({
            datum: r,
            postSubmit: (e) => {
                r.to_add && d(r, t.getData()),
                    e &&
                    e.delete &&
                    (r.main && t.updateMainId(null), c(r, t.getData())),
                    t.updateTree();
            },
            store: t,
        });
    ...
    function T(t, { d: e }) {
        (e.data.hide_rels = !e.data.hide_rels),
            s(e, e.data.hide_rels),
            t.updateTree({ tree_position: t.state.tree_fit_on_change });
    }
    function E() {
    ...
    var it = Object.freeze({
        __proto__: null,
        manualZoom: function ({ amount: t, svg: e, transition_time: n = 500 }) {
            const i = e.__zoomObj;
            r.select(e)
                .transition()
                .duration(n || 0)
        ...
        addNewPersonAndHandleRels: function ({
            ...
            m({ data_stash: e, datum: t }),
                u({ datum: t, data_stash: e, rel_type: n, rel_datum: r });
        },
        ...
        createForm: function ({
            ...
            const l = {
                ...
                onSubmit: function (e) {
                    ...
                    const handleSubmit = (avatarBase64 = null) => {
                        formData.forEach((value, key) => {
                            if (key === "avatar") {
                                if (avatarBase64) {
                                    t.data[key] = avatarBase64;
                                } // si no hay archivo, simplemente no lo agrega
                            } else {
                                t.data[key] = value;
                            }
                        });

                        if (t.to_add) delete t.to_add;
                        r(); // callback
                    };

                    if (avatarFile instanceof File && avatarFile.size > 0) {
                        const reader = new FileReader();
                        reader.onload = () => handleSubmit(reader.result); // base64 string
                        reader.readAsDataURL(avatarFile); // convierte a data:image/...;base64,...
                    } else {
                        handleSubmit(); // no hay imagen
                    }
                },
            };
            return (
                ...
                ((l.onDelete = function () {
                    ...
                    (l.addRelative = () => i.activate(t)),
                    (l.addRelativeCancel = () => i.onCancel()),
                    (l.addRelativeActive = i.is_active),
                    (l.editable = !1)),
                t._new_rel_data &&
                ((l.title = t._new_rel_data.label),
                    (l.new_rel = !0),
                    (l.editable = !0),
                    (l.onCancel = s)),
                l.onDelete && (l.can_delete = o(t, e.getData())),
                d && (l.editable = !0),
                (l.gender_field = {
                    id: "gender",
                    type: "switch",
            ...
            function r() {
                const i = (function (t) {
                    ...
                    <form id="familyForm" class="f3-form ${t.editable ? "" : "non-editable"}">
                        ${o()} ${t.title ? `<h3 class="f3-form-title">${t.title}</h3>` : ""}
                    ...
                    function e() {
                        return `<div>
                            <button type="button" class="f3-delete-btn" ${t.can_delete ? "" : "disabled"}>Delete</button>
                        </div>`;
                    }
                    function n() {
                    ...
                    function r() {
                        return `<span class="f3-edit-btn">${t.editable ? Q() : G()}</span>`;
                    }
                    function i() {
                        return t.editable ? `<div class="f3-radio-group">${t.gender_field.options.map(
                            (e) =>
                                `<label>
                                    <input type="radio" name="${t.gender_field.id}" value="${e.value}"${e.value === t.gender_field.initial_value ? "checked" : ""}>
                                    ${e.label}
                                </label>`,
                        ).join("")}</div>` : "";
                    }
                    function a() {
                                ...
                                .map((t) =>
                                    t.id === "avatar"
                                        ? `<div class="f3-form-field">
                                            <label>${t.label}</label>
                                            <input type="file" name="${t.id}" accept="image/*">
                                            </div>`
                                        : t.type === "text"
                                            ? `<div class="f3-form-field">
                                                <label>${t.label}</label>
                        ...
                        function e() {
                            var gender =
                                t.gender_field.initial_value == "M"
                                    ? "male"
                                    : "female";

                            const avatarField = t.fields.find(
                                (f) => f.id === "avatar",
                            );
                            const otherFields = t.fields.filter(
                                (f) => f.id !== "avatar",
                            );
                    ...
                    function o() {
                        return '<span  class="f3-close-btn" >×</span>';
                    }
                    function d() {
                ...
                return (
                    ...
                    (function () {
                        ...
                        i
                            .querySelector(".f3-close-btn")
                            .addEventListener("click", e),
                            t.other_parent_field && (a.style.display = "none");
                        function l() {
        ...
        createHistoryControls: function (t, e, n = () => { }) {
            ...
            return (
                ...
                s.html(K()),
                {
                    ...
                    destroy: function () {
                        (e = null),
                            r.select(t).select(".f3-history-controls").remove();
                    },
                }
            );
            function o() {
                a.classed("disabled", !e.canBack()),
                    s.classed("disabled", !e.canForward()),
                    i.style(
                        "display",
                        e.canBack() || e.canForward() ? null : "none",
                    );
            }
        },
        treeFit: b,
    ...
    function at({ d: t, card_dim: e, card_display: n }) {
        return {
            template: `\n    <g>\n      <g class="card-text" clip-path="url(#card_text_clip)">\n        <g transform="translate(${e.text_x
                }, ${e.text_y})">\n          <text>\n            ${Array.isArray(n)
                    ? n
                        .map(
                            (e) =>
                                `<tspan x="0" dy="14">${e(t.data)}</tspan>`,
                        )
                        .join("\n")
                    : n(t.data)
                }\n          </text>\n        </g>\n      </g>\n      <rect width="${e.w - 10
                }" height="${e.h
                }" style="mask: url(#fade)" class="text-overflow-mask" /> \n    </g>\n  `,
        };
    }
    function st({ x: t, y: e, rt: n, closed: r }) {
        return {
    ...
    const ot = {
        miniTree: function (t, e) {
            ...
            const i = r.create("svg:g").html(
                (function ({ d: t, card_dim: e }) {
                    return {
                        template: `\n    <g class="card_family_tree" style="cursor: pointer">\n      <rect x="-31" y="-25" width="72" height="15" fill="rgba(0,0,0,0)"></rect>\n      <g transform="translate(${0.8 * e.w
                            },6)scale(.9)">\n        <rect x="-31" y="-25" width="72" height="15" fill="rgba(0,0,0,0)"></rect>\n        <line y2="-17.5" stroke="#fff" />\n        <line x1="-20" x2="20" y1="-17.5" y2="-17.5" stroke="#fff" />\n        <rect x="-31" y="-25" width="25" height="15" rx="5" ry="5" class="card-male" />\n        <rect x="6" y="-25" width="25" height="15" rx="5" ry="5" class="card-female" />\n      </g>\n    </g>\n  `,
                    };
                })({ d: t, card_dim: n }).template,
            );
            return (
                i.on("click", function (n) {
                    n.stopPropagation(),
                        e.onMiniTreeClick
                            ? e.onMiniTreeClick.call(this, n, t)
                            : H(e.store, { d: t });
                }),
                i.node()
            );
        ...
        lineBreak: function (t, e) {
            ...
            return (
                i.on("click", (n) => {
                    n.stopPropagation(), T(e.store, { d: t });
                }),
                i.node()
            );
        },
        cardBody: function (t, e) {
            ...
            let a;
            t.data.to_add
                ? ((a = r.create("svg:g").html(
                    (function ({ d: t, card_dim: e, card_add: n, label: r }) {
                        return {
                            template: `\n    <g class="card-body ${n ? "card_add" : "card-unknown"
                                }">\n      <rect class="card-body-rect" width="${e.w
                                }" height="${e.h
                                }" fill="rgb(59, 85, 96)" />\n      <text transform="translate(${e.w / 2
                                }, ${e.h / 2
                    ...
                    a.on("click", (n) => {
                        n.stopPropagation(),
                            D(e.store, { d: t, cardEditForm: e.cardEditForm });
                    }))
                : ((a = r.create("svg:g").html(
                    (function ({ d: t, card_dim: e, card_display: n }) {
                        return {
                            template: `\n    <g class="card-body">\n      <rect width="${e.w
                                }" height="${e.h
                                }" class="card-body-rect" />\n      ${at({ d: t, card_dim: e, card_display: n })
                                    .template
                                }\n    </g>\n  `,
                        };
                    })({ d: t, card_dim: i, card_display: e.card_display })
                        .template,
                )),
                    a.on("click", function (n) {
                        n.stopPropagation(),
                            e.onCardClick
                                ? e.onCardClick.call(this, n, t)
                                : H(e.store, { d: t });
                    }));
            return a.node();
        },
            ...
            return r
                ...
                .html(
                    (function ({
                        ...
                        return {
                            template: `\n    <g style="transform: translate(${n.img_x
                                }px,${n.img_y
                                }px);" class="card_image" clip-path="url(#card_image_clip)">\n      ${e
                                    ? `<image href="${e}" height="${n.img_h}" width="${n.img_w}" preserveAspectRatio="xMidYMin slice" />`
                                    : "F" === t.data.data.gender && i
                                        ? i({ card_dim: n })
                                        : "M" === t.data.data.gender && r
                                            ? r({ card_dim: n })
                                            : `\n      <g class="genderless-icon">\n        <rect height="${n.img_h
                                            }" width="${n.img_w
                                            }" fill="rgb(59, 85, 96)" />\n        <g transform="scale(${0.001616 * n.img_w
        ...
        cardAdd: function (t, e) {
            ...
            const n = e.card_dim,
                i = r.create("svg:g").html(
                    ...
                    })({ card_dim: n, x: n.w - 26, y: n.h - 20 }).template,
                );
            return (
                i.on("click", (n) => {
                    n.stopPropagation(), e.addRelative({ d: t });
                }),
                i.node()
            );
        },
    ...
    function lt(t, e) {
        function n(t, e, n) {
            const { w: r, h: i } = t,
                ...
                s = n || [],
                o = (t) => s.includes(t);
            return `${o("lx") ? "M0,0" : `M0,${a} Q 0,0 5,0`} ${o("rx") ? `H${r}` : `H${r - a} Q ${r},0 ${r},5`
                } ${o("ry") ? `V${i}` : `V${i - a} Q ${r},${i} ${r - a},${i}`} ${o("ly") ? "H0" : `H${a} Q 0,${i} 0,${i - a}`
                } z`;
        }
        t.querySelector("defs#f3CardDef") ||
            t.insertAdjacentHTML(
                "afterbegin",
                `\n      <defs id="f3CardDef">\n        <linearGradient id="fadeGrad">\n          <stop offset="0.9" stop-color="white" stop-opacity="0"/>\n          <stop offset=".91" stop-color="white" stop-opacity=".5"/>\n          <stop offset="1" stop-color="white" stop-opacity="1"/>\n        </linearGradient>\n        <mask id="fade" maskContentUnits="objectBoundingBox"><rect width="1" height="1" fill="url(#fadeGrad)"/></mask>\n        <clipPath id="card_clip"><path d="${n(
                    { w: e.w, h: e.h },
                    5,
                )}"></clipPath>\n        <clipPath id="card_text_clip"><rect width="${e.w - 10
                }" height="${e.h
                }"></rect></clipPath>\n        <clipPath id="card_image_clip"><path d="M0,0 Q 0,0 0,0 H${e.img_w
                } V${e.img_h} H0 Q 0,${e.img_h} 0,${e.img_h
                } z"></clipPath>\n        <clipPath id="card_image_clip_curved"><path d="${n(
                    { w: e.img_w, h: e.img_h },
                    5,
                    ["rx", "ry"],
                )}"></clipPath>\n      </defs>\n    `,
    ...
    var ct = Object.freeze({
        ...
        Card: function (t) {
            return (
                ...
                function (e) {
                    const n =
                        "M" === e.data.data.gender
                            ? "card-male"
                            : "F" === e.data.data.gender
                                ? "card-female"
                                : "card-genderless",
                        i = t.card_dim,
                        a = r
                    ...
                    a
                        ...
                        (function (t, e, n) {
                            ...
                            (function ({ d: t, card_dim: e, is_new: n }) {
                                return {
                                    template: `\n    <rect width="${e.w
                                        }" height="${e.h
                                        }" rx="4" ry="4" class="card-outline ${t.data.main && !n
                                            ? "card-main-outline"
                                            : ""
                                        } ${n ? "card-new-outline" : ""}" />\n  `,
                                };
                            })({ d: e, card_dim: i, is_new: e.data.to_add })
                                .template,
                            a.node(),
                            !0,
                        ),
                        dt(
                            ot.cardBody(e, t),
                            this.querySelector(".card-inner"),
                        ),
                        t.img &&
                        dt(ot.cardImage(e, t), this.querySelector(".card")),
                        t.mini_tree &&
                        dt(
                            ot.miniTree(e, t),
                        ...
                        t.link_break &&
                        dt(ot.lineBreak(e, t), this.querySelector(".card")),
                        t.cardEditForm &&
                        (dt(
                            ot.cardEdit(e, t),
                            this.querySelector(".card-inner"),
                        ...
                        t.onCardUpdates &&
                        t.onCardUpdates.map((t) => t.call(this, e)),
                        t.onCardUpdate && t.onCardUpdate.call(this, e);
                }
            );
        },
        CardHtml: function (t) {
                        ...
                        : "imageCircle" === t.style
                            ...
                            : "imageRect" === t.style
                                ...
                                : "rect" === t.style
                                    ...
                                    : a;
            return function (n) {
                (this.innerHTML = `\n    <div class="card ${(function (t) {
                    const e = [];
                    "M" === t.data.data.gender
                        ? e.push("card-male")
                        : "F" === t.data.data.gender
                            ? e.push("card-female")
                            : e.push("card-genderless");
                    t.data.main && e.push("card-main");
                    t.data._new_rel_data && e.push("card-new-rel");
                    t.data.to_add && e.push("card-to-add");
                    return e;
                })(n).join(" ")}" data-id="${n.data.id
                    }" style="transform: translate(-50%, -50%); pointer-events: auto;">\n      ${t.mini_tree
                        ? (function (e) {
                            return t.mini_tree
                                ? e.data.to_add ||
                                    e.data._new_rel_data ||
                                    e.all_rels_displayed
                                    ? ""
                                    : `<div class="mini-tree">${tt()}</div>`
                                : "";
                        })(n)
                        : ""
                    }\n      ${e(n)}\n    </div>\n    `),
                    ...
                    t.onCardUpdate && t.onCardUpdate.call(this, n),
                    t.onCardMouseenter &&
                    r
                        .select(this)
                        .select(".card")
                        .on("mouseenter", (e) => t.onCardMouseenter(e, n)),
                    t.onCardMouseleave &&
                    r
                        .select(this)
                        .select(".card")
                        .on("mouseleave", (e) => t.onCardMouseleave(e, n));
            };
            function n(t) {
                return `\n    <div class="card-inner card-image-rect" ${d()}>\n      ${t.data.data.avatar
                    ? `<img src="${t.data.data.avatar}" ${l()}>`
                    : c(t)
            ...
            function i(e) {
                return e.data._new_rel_data
                    ? (function (t) {
                        const e = [];
                        e.push(
                            `data-rel-type="${t.data._new_rel_data.rel_type}"`,
                        ),
                            ["son", "daughter"].includes(
                                t.data._new_rel_data.rel_type,
                            ) &&
                            e.push(
                                `data-other-parent-id="${t.data._new_rel_data.other_parent_id}"`,
                            );
                        return `<div ${e.join(" ")}>${t.data._new_rel_data.label
                            }</div>`;
                    })(e)
                    : e.data.to_add
                        ? `<div>${t.empty_card_label || "ADD"}</div>`
                        : `\n      ${t.card_display
                            .map((t) => `<div>${t(e.data)}</div>`)
                            .join("")}\n    `;
            }
            function a(t) {
                return n(t);
            ...
            function d() {
                let e = 'style="';
                return t.card_dim.w || t.card_dim.h
                    ? ((e += `width: ${t.card_dim.w}px; min-height: ${t.card_dim.h}px;`),
                        t.card_dim.height_auto
                            ? (e += "height: auto;")
                            : (e += `height: ${t.card_dim.h}px;`),
                        (e += '"'),
                        e)
                    : "";
            }
            function l() {
                ...
                return t.card_dim.img_w ||
                    t.card_dim.img_h ||
                    t.card_dim.img_x ||
                    t.card_dim.img_y
                    ? ((e += `width: ${t.card_dim.img_w}px; height: ${t.card_dim.img_h}px;`),
                        (e += `left: ${t.card_dim.img_x}px; top: ${t.card_dim.img_y}px;`),
                        (e += '"'),
                        e)
                    : "";
            }
            function c(t) {
                return t.data._new_rel_data
                    ? `<div class="person-icon" ${l()}>${W()}</div>`
                    : `<div class="person-icon" ${l()}>${X()}</div>`;
            }
        },
    });
    function ht(t, e, n) {
    ...
    function pt(t, e) {
        return (
            ...
            (this.is_horizontal = !1),
            (this.single_parent_empty_card = !0),
            (this.transition_time = 2e3),
            (this.is_card_html = !1),
                ...
                ? t.forEach((t) => {
                    "function" == typeof t
                        ...
                        : "string" == typeof t
                            ? e.push((e) => e.data[t])
                            : Array.isArray(t) &&
                            e.push((e) => t.map((t) => e.data[t]).join(" "));
                })
                : "function" == typeof t
                    ? e.push(t)
                    : "string" == typeof t && e.push((e) => e.data[t]),
            e
        );
    }
    function _t(...t) {
    ...
    function mt(t, e) {
        return (
            ...
            (this.card_display = [
                (t) => `${t.data["first name"]} ${t.data["last name"]}`,
            ]),
            (this.mini_tree = !0),
            (this.link_break = !1),
    ...
    (ht.prototype.activate = function (t) {
        ...
        const n = (function (t, e, n) {
            const r = (function (t, e) {
                ...
                function r(t, r) {
                    const i = (function (t, e) {
                        return JSON.parse(
                            JSON.stringify(t.find((t) => t.id === e)),
                        );
                    })(e, r);
                    ("father" !== t && "mother" !== t) ||
                        (delete i.rels.father, delete i.rels.mother),
                        "children" === t &&
                        ((i.rels.children = []), (i.rels.spouses = [])),
                        n.push(i);
                }
            })(t, e);
            if (!t.rels.father) {
                ...
                (e._new_rel_data = { rel_type: "father", label: n.father }),
                    (t.rels.father = e.id),
                    r.push(e);
            }
            if (!t.rels.mother) {
                ...
                (e._new_rel_data = { rel_type: "mother", label: n.mother }),
                    (t.rels.mother = e.id),
                    r.push(e);
            }
            ...
            (i.rels.spouses = [a.id]),
                (a.rels.spouses = [i.id]),
                (i.rels.children = [t.id]),
                (a.rels.children = [t.id]),
                t.rels.spouses || (t.rels.spouses = []);
            if (t.rels.children) {
                let e;
                t.rels.children.forEach((i) => {
                    ...
                    a.rels.mother ||
                        (e ||
                            ...
                            e.rels.children.push(a.id),
                            t.rels.spouses.push(e.id),
                            (a.rels.mother = e.id),
                            r.push(e)),
                        a.rels.father ||
                        (e ||
            ...
            const s = f({ data: { gender: "F" }, rels: { spouses: [t.id] } });
            (s._new_rel_data = { rel_type: "spouse", label: n.spouse }),
                t.rels.spouses.push(s.id),
                r.push(s),
                t.rels.children || (t.rels.children = []);
            return (
                t.rels.spouses.forEach((e) => {
                    const i = r.find((t) => t.id === e);
                    i.rels.children || (i.rels.children = []),
                        (i.rels.children = i.rels.children.filter((e) =>
                            t.rels.children.includes(e),
                        ));
                    const a = f({
                        data: { gender: "M" },
                        rels: { father: t.id, mother: i.id },
                    });
                    (a._new_rel_data = {
                        rel_type: "son",
                        label: n.son,
                        ...
                        i.rels.children.push(a.id),
                        t.rels.children.push(a.id),
                        r.push(a);
                    const s = f({
                        data: { gender: "F" },
                        rels: { mother: i.id, father: t.id },
                    });
                    (s._new_rel_data = {
                        rel_type: "daughter",
                        label: n.daughter,
                        ...
                        i.rels.children.push(s.id),
                        t.rels.children.push(s.id),
                        r.push(s);
                }),
                r
            );
        })(
            (t = JSON.parse(JSON.stringify(this.datum))),
            this.getStoreData(),
            this.addRelLabels,
        );
        e.updateData(n),
            ...
            (this.onChange = function (t) {
                if (t?._new_rel_data) {
                    ...
                    t.id === this.datum.id
                        ? (this.datum.data = t.data)
                        : console.error("Something went wrong");
            }.bind(this)),
            (this.onCancel = function () {
                if (!this.is_active) return;
                (this.is_active = !1),
                    e.updateData(this.getStoreData()),
        ...
        (ut.prototype.cardEditForm = function (t) {
            const e = {};
            t?._new_rel_data
                ? (e.onCancel = () => this.addRelativeInstance.onCancel())
                : ((e.addRelative = this.addRelativeInstance),
                    (e.deletePerson = () => {
                        const e = this.store.getData();
                        c(t, e),
                            this.store.updateData(e),
                            this.openFormWithId(
                                this.store.getLastAvailableMainDatum().id,
                            ),
            ...
            const n = vt.handlers.createForm({
                ...
                postSubmit: function (e) {
                    this.addRelativeInstance.is_active
                        ? this.addRelativeInstance.onChange(t)
                        : e?.delete || this.openFormWithId(t.id);
        ...
        (ut.prototype.closeForm = function () {
            r.select(this.form_cont).classed("opened", !1).html(""),
                this.store.updateTree({});
        }),
        (ut.prototype.fixed = function () {
            return (
                (this.is_fixed = !0),
                r.select(this.form_cont).style("position", "relative"),
                this
            );
        }),
        (ut.prototype.absolute = function () {
            return (
                (this.is_fixed = !1),
                r.select(this.form_cont).style("position", "absolute"),
                this
            );
        }),
        (ut.prototype.setCardClickOpen = function (t) {
            return (
                t.setOnCardClick((t, e) => {
                    this.addRelativeInstance.is_active
                        ? this.open(e)
                        : (this.open(e),
                            this.store.updateMainId(e.data.id),
                            this.store.updateTree({}));
                }),
                this
            );
        ...
        (ut.prototype.openFormWithId = function (t) {
            if (t) {
                ...
                this.openWithoutRelCancel({ data: e });
            } else {
                const t = this.store.getMainDatum();
                this.openWithoutRelCancel({ data: t });
            }
        }),
        (ut.prototype.createHistory = function () {
            return (
                (this.history = vt.handlers.createHistory(
                    this.store,
                    this.getStoreData.bind(this),
                    function () {
                        this.addRelativeInstance.is_active &&
                            this.addRelativeInstance.onCancel();
                        this.store.updateTree({ initial: !1 }),
                            this.history.controls.updateButtons(),
                            this.openFormWithId(this.store.getMainDatum()?.id);
                    }.bind(this),
                )),
                (this.history.controls = vt.handlers.createHistoryControls(
                    this.cont,
                    this.history,
                )),
        ...
        (ut.prototype.setFields = function (t) {
            const e = [];
            if (!Array.isArray(t))
                return console.error("fields must be an array"), this;
            for (const n of t)
                "string" == typeof n
                    ? e.push({ type: "text", label: n, id: n })
                    : "object" == typeof n
                        ? n.id
                            ? e.push(n)
                            : console.error(
                                "fields must be an array of objects with id property",
                            )
                        : console.error(
                            "fields must be an array of strings or objects",
                        );
        ...
        (ut.prototype.addRelative = function (t) {
            return (
                t || (t = this.store.getMainDatum()),
                this.addRelativeInstance.activate(t),
                this
            );
        }),
        (ut.prototype.setupAddRelative = function () {
            return ((...t) => new ht(...t))(
                this.store,
                function (t) {
                    this.store.updateMainId(t.id),
                        this.store.updateTree({}),
                        this.openFormWithId(t.id);
                }.bind(this),
                function (t, e) {
        ...
        (ut.prototype.getStoreData = function () {
            return this.addRelativeInstance.is_active
                ? this.addRelativeInstance.getStoreData()
                : this.store.getData();
        }),
        ...
        (ut.prototype.updateHistory = function () {
            this.history &&
                (this.history.changed(), this.history.controls.updateButtons()),
        ...
        (ut.prototype.destroy = function () {
            return (
                ...
                (this.history = null),
                r.select(this.cont).select(".f3-form-cont").remove(),
                this.addRelativeInstance.onCancel &&
                this.addRelativeInstance.onCancel(),
                this.store.updateTree({}),
                this
        ...
        (pt.prototype.init = function (t, e) {
            ...
            (this.svg = vt.createSvg(t, {
                onZoom: vt.htmlHandlers.onZoomSetup(
                    () => t.querySelector("svg .view"),
                    () => t.querySelector("#htmlSvg .cards_view"),
                ),
            })),
                vt.htmlHandlers.createHtmlSvg(t),
                (this.store = vt.createStore({
                    data: e,
                ...
                this.setCard(vt.CardSvg),
                this.store.setOnUpdate((e) => {
                    this.beforeUpdate && this.beforeUpdate(e),
                        (e = Object.assign(
                        ...
                        this.afterUpdate && this.afterUpdate(e);
                });
        }),
        (pt.prototype.updateTree = function (t = { initial: !1 }) {
        ...
        (pt.prototype.setCardYSpacing = function (t) {
            return "number" != typeof t
                ? (console.error("card_y_spacing must be a number"), this)
                : ((this.level_separation = t),
                    (this.store.state.level_separation = t),
                    this);
        }),
        (pt.prototype.setCardXSpacing = function (t) {
            return "number" != typeof t
                ? (console.error("card_x_spacing must be a number"), this)
                : ((this.node_separation = t),
                    (this.store.state.node_separation = t),
                    this);
        }),
        (pt.prototype.setOrientationVertical = function () {
            return (
                (this.is_horizontal = !1),
                (this.store.state.is_horizontal = !1),
                this
            );
        }),
        (pt.prototype.setOrientationHorizontal = function () {
            return (
                (this.is_horizontal = !0),
                (this.store.state.is_horizontal = !0),
                this
            );
        }),
        (pt.prototype.setSingleParentEmptyCard = function (
            t,
            { label: e = "Unknown" } = {},
        ) {
            return (
                (this.single_parent_empty_card = t),
                (this.store.state.single_parent_empty_card = t),
                (this.store.state.single_parent_empty_card_label = e),
                ...
                vt.handlers.removeToAddFromData(this.store.getData() || []),
                this
            );
        }),
        (pt.prototype.setCard = function (t) {
            (this.is_card_html = t.is_html),
                this.is_card_html
                    ? ((this.svg.querySelector(".cards_view").innerHTML = ""),
                        (this.cont.querySelector("#htmlSvg").style.display =
                            "block"))
        ...
        (pt.prototype.updateMain = function (t) {
            return (
                this.store.updateMainId(t.data.id),
                this.store.updateTree({}),
                this
            );
        }),
        ...
        (mt.prototype.setCardDim = function (t) {
            if ("object" != typeof t)
                return console.error("card_dim must be an object"), this;
            for (let e in t) {
                const n = t[e];
                if ("number" != typeof n)
                    return (
                        console.error(`card_dim.${e} must be a number`), this
                    );
                "width" === e && (e = "w"),
                    "height" === e && (e = "h"),
                    (this.card_dim[e] = n);
            ...
            return (
                (function (t, e) {
                    t.querySelector("defs#f3CardDef") &&
                        t.querySelector("defs#f3CardDef").remove(),
                        lt(t, e);
                })(this.svg, this.card_dim),
                this
            );
        }),
        ...
        (mt.prototype.setCardTextSvg = function (t) {
            function e(e) {
                r
                    .select(this)
                    .select(".card-text text")
                    .node().parentNode.innerHTML = t(e.data);
            }
            return (
                (e.id = "setCardTextSvg"),
                this.onCardUpdates || (this.onCardUpdates = []),
                (this.onCardUpdates = this.onCardUpdates.filter(
                    (t) => "setCardTextSvg" !== t.id,
                )),
                this.onCardUpdates.push(e),
                this
            );
        }),
        ...
        (yt.is_html = !0),
        (gt.prototype.is_html = !0),
        (gt.prototype.init = function () {
            (this.svg = this.cont.querySelector("svg.main_svg")),
                (this.getCard = () =>
                    vt.elements.CardHtml({
                        store: this.store,
                        card_display: this.card_display,
                        onCardClick: this.onCardClick,
                        style: this.style,
        ...
        (gt.prototype.setCardDim = function (t) {
            ...
            for (let e in t) {
                ...
                if ("number" != typeof n && "boolean" != typeof n)
                    return (
                        console.error(
                            `card_dim.${e} must be a number or boolean`,
                        ),
                        this
                    );
                "width" === e && (e = "w"),
        ...
        (gt.prototype.onEnterPathToMain = function (t, e) {
            ...
            const n = this.store.getTreeMainDatum(),
                ...
                [s, o] = (function (t, e, n, r) {
                    ...
                    if (i) {
                        ...
                        for (; l !== r.data && c < 100;) {
                            ...
                            const t = a.find(
                                (t) =>
                                    !0 === t.spouse &&
                                    (t.source === l || t.target === l),
                            );
                            if (t) {
                                const e = a.find(
                                    (e) =>
                                        Array.isArray(e.target) &&
                                        e.target.includes(t.source) &&
                                        e.target.includes(t.target),
                                );
                                if (!e) break;
                        ...
                        e.each(function (t) {
                            i.includes(t) && s.push({ link: t, node: this });
                        });
                        const h = d(n, i);
                        t.each(function (t) {
                            h.includes(t) && o.push({ card: t, node: this });
                        });
                    } else if (n.spouse && n.spouse.data === r.data) {
                        e.each(function (t) {
                            t.target === n && s.push({ link: t, node: this });
                        });
                        const i = [r, n];
                        t.each(function (t) {
                            i.includes(t) && o.push({ card: t, node: this });
                        });
                    } else {
                        let i = [],
                            l = n,
                        ...
                        for (; l !== r.data && c < 100;) {
                            ...
                            const t = a.find(
                                (t) =>
                                    t.target === l && Array.isArray(t.source),
                            );
                            if (t) {
                                const e = a.find((e) => {
                                    return (
                                        ...
                                        ((n = [e.source, e.target]),
                                            (r = t.source),
                                            n.every((t) => r.some((e) => t === e)))
                                    );
                                    var n, r;
                                });
                                i.push(t),
                                    i.push(e),
                                    (l = e ? e.source : t.source[0]);
                            } else {
                                const t = a.find(
                                    (t) =>
                                        t.target === l &&
                                        !Array.isArray(t.source),
                                );
                                if (!t) break;
                                i.push(t), (l = t.source);
                            }
                    ...
                    function d(t, e) {
                        ...
                        return (
                            (function t(e) {
                                e.data.rels.children &&
                                    e.data.rels.children.forEach((e) => {
                                        const n = i.find(
                                            (t) => t.data.id === e,
                                        );
                                        n && (a.push(n), t(n));
            ...
            return (
                s.forEach((t) => {
                    ...
                    r.select(t.node.querySelector("div.card-inner"))
                        .transition()
                        .duration(0)
                        .delay(n)
                        .on(
                            ...
                            () =>
                                ...
                                r
                                    .select(
                                        t.node.querySelector("div.card-inner"),
                                    )
                                    .classed("f3-path-to-main", !0),
                        );
                }),
                o.forEach((t) => {
                    ...
                    r.select(t.node)
                        ...
                        .on(
                            ...
                            () =>
                                this.to_transition === e.data.id &&
                                r.select(t.node).classed("f3-path-to-main", !0),
                        );
                }),
                this
            );
        ...
        (gt.prototype.onLeavePathToMain = function (t, e) {
            return (
                (this.to_transition = !1),
                r
                    .select(this.cont)
                    .select("div.cards_view")
                    .selectAll("div.card-inner")
                    .classed("f3-path-to-main", !1),
                r
                    .select(this.cont)
                    .select("svg.main_svg .links_view")
                    .selectAll(".link")
    ...
    var vt = {
        ...
        createStore: function (t) {
            ...
            return (
                (n.main_id_history = []),
                {
                    ...
                    updateTree: (t) => {
                        (n.tree = v({
                            ...
                            single_parent_empty_card:
                                n.single_parent_empty_card,
                            is_horizontal: n.is_horizontal,
                        })),
                            n.main_id || i(n.tree.main_id),
                            e && e(t);
                    },
                    ...
                    getTreeMainDatum: function () {
                        return n.tree
                            ? n.tree.data.find((t) => t.data.id === n.main_id)
                            : null;
                    },
                    getTreeDatum: function (t) {
                        return n.tree
                            ? n.tree.data.find((e) => e.id === t)
                            : null;
                    },
                    getLastAvailableMainDatum: function () {
                        let t = n.main_id_history
                            .slice(0)
                            .reverse()
                            .find((t) => r(t));
                        t || (t = n.data[0].id);
            ...
            function i(t) {
                t !== n.main_id &&
                    ((n.main_id_history = n.main_id_history
                        .filter((e) => e !== t)
                        .slice(-10)),
                        n.main_id_history.push(t),
                        (n.main_id = t));
            }
        },
        view: function (t, e, n, i = {}) {
            (i.initial = i.hasOwnProperty("initial")
                ? i.initial
                : !r.select(e.parentNode).select(".card_cont").node()),
                (i.transition_time = i.hasOwnProperty("transition_time")
                    ? i.transition_time
                    : 2e3),
                i.cardComponent
                    ? (function (t, e, n, i = {}) {
                        ...
                        o.each((t) => a(t, !1, !0)),
                            ...
                            o.each(function (t) {
                                const e = r.select(n(t)),
                                    a = r.select(this);
                                e.transition()
                                    .duration(i.transition_time)
                                    .style("opacity", 0)
                                    .style(
                                        "transform",
                                        `translate(${t._x}px, ${t._y}px)`,
                                    )
                                    .on("end", () => a.remove());
                            }),
                            s.each(function (t) { }),
                ...
                (function (t, e, n = {}) {
                    ...
                    o.each(function (t) {
                        const e = r.select(this);
                        e.transition("op").duration(800).style("opacity", 0),
                            e
                                .transition("path")
                                .duration(n.transition_time)
                                .attr("d", M(t, !0))
                                .on("end", () => e.remove());
                    }),
                        d.each(function (t) {
